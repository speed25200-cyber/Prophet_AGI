...
def test_memory_coda_mount_reads_the_configured_local_layer(recurrent):
    """Coda mounting is explicit; dense models use the equivalent trunk location."""
